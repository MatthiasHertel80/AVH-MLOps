...
install_arm_license_manager() {
	ARCH=$(uname -m)
	if [ "$ARCH" == "x86_64" ]; then
		URL="https://artifacts.tools.arm.com/armlm/1.3.0/armlm-1.3.0-lin-x86_64-none-gui.tar.gz"
	elif [ "$ARCH" == "aarch64" ]; then
		URL="https://artifacts.tools.arm.com/armlm/1.3.0/armlm-1.3.0-lin-arm_64-none-gui.tar.gz"
	else
